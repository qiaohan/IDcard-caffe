 ...
 ************************************************************************
*/
std::vector<PathPair> FilePathClass::getFilePath( const std::string &folder, const std::string &ext, PATH_TYPE mode /*= NO_RECURSIVE*/ ) const
{
 ...
 ************************************************************************
*/
std::vector<PathPair> FilePathClass::getFolder( const std::string &folder ) const
{
	using namespace boost::filesystem;
	if (!exists(folder) || !is_directory(folder))
	{
